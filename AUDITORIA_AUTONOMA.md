...
> 4d) corre a auditoria master `node scripts/e2e_auditoria_master.mjs` (responsividade, rede, performance, a11y, segurança cross-tenant, UX, validações; esperado: 39 PASS / 0 WARN / 0 FAIL — o advisory N3 foi fechado em 2026-08-09);
