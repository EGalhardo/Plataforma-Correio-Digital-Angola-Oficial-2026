...
export const TRANSLATE_MAP: Record<string, Record<LanguageCode, string>> = {
  ...
  "República de Angola": {
    ...
    um: "Ofula ya Angola",
    ki: "Ntotela ya Angola",
    kk: "Nsi ya Angola",
    ch: "Fuchi ya Angola",
    ng: "Kanda ya Angola",
    kw: "Oshilongo shAngola",
    nh: "Omuhele wa Angola",
    fi: "Nsi ya Angola"
  },
  "Segurança": {
    pt: "Segurança",
  ...
  "Voltar ao Painel": {
    pt: "Voltar ao Painel",
    um: "Okutunda ko Ondunge",
    ki: "Kutula ko Kikonde",
    kk: "Kuna ko Lulendo",
    ch: "Kuhita ko Fungola",
    ng: "Kushola ko Mutende",
    kw: "Okushoka ko Oshila",
    nh: "Okutyi ko Okulula",
    fi: "Maboti ko Lusolo"
  },
  "Voltar ao Correio": {
    pt: "Voltar ao Correio",
    um: "Okutunda ko Okanda",
    ki: "Kutula ko Mikanda",
    kk: "Kuna ko Nsamu",
    ch: "Kuhita ko Chisinde",
    ng: "Kushola ko Mikando",
    kw: "Okushoka ko Ombila",
    nh: "Okutyi ko Okanda",
    fi: "Maboti ko Bumboti"
  },
  "Remover anexo": {
    pt: "Remover anexo",
    um: "Okupuka onanga",
    ki: "Kupuka kimbu",
    kk: "Kupuka nsamu",
    ch: "Kupuka chinyingika",
    ng: "Kupuka cinoneno",
    kw: "Okupuka endandeko",
    nh: "Okupuka okutaila",
    fi: "Kupuka dimbu"
  },
  "Localização": {
  ...
  "Conteúdo do Documento": {
    ...
    um: "Otyo kokanda",
    ki: "Kimbu kia mukanda",
    kk: "Nsamu kia nzo",
    ch: "Kufunga kwa mukanda",
    ng: "Kisalu kya mikando",
    kw: "Oshipala shombila",
    nh: "Ovitu vyokanda",
    fi: "Nzila ya mukanda"
  },
  "Referência de Registo": {
    pt: "Referência de Registo",
    um: "Ondaka yokala",
    ki: "Kimbu kia kusonga",
    kk: "Nsamu ya kusonga",
    ch: "Chinyingika kusonga",
    ng: "Cinoneno kusonga",
    kw: "Endandeko okusonga",
    nh: "Okutaila okusonga",
    fi: "Dimbu songa"
  },
  "Entrar": {
    pt: "Entrar",
  ...
  "Conta verificada e activa": {
    pt: "Conta verificada e activa",
    um: "Ombila yokutavela",
    ki: "Mbandu yatavela",
    kk: "Nzo yatavela",
    ch: "Mufu watavela",
    ng: "Mukulo watavela",
    kw: "Omauyelele atavela",
    nh: "Omuhonga watavela",
    fi: "Nzila yatavela"
  },
  "Alterar Foto": {
    pt: "Alterar Foto",
  ...
  "Carregar nova foto": {
    pt: "Carregar nova foto",
    um: "Okutwala efoto ehe",
    ki: "Kutwala foto hima",
    kk: "Kutwala foto hima",
    ch: "Kutwala foto hima",
    ng: "Kutwala foto hima",
    kw: "Okutwala efoto hima",
    nh: "Okutwala efoto hima",
    fi: "Twala foto hima"
  },
  "Último Acesso": {
    pt: "Último Acesso",
  ...
  "Temperatura": {
    ...
    ch: "Kufunga kwosi",
    ng: "Kisalu kyosi",
    kw: "Oshilongwa shoshi",
    nh: "Omuhonga yosi",
    fi: "Nzila yosi"
  },
  "Responsável Institucional": {
    pt: "Responsável Institucional",
    um: "Okutwala ovingonjo",
    ki: "Kutwala vihandela",
    kk: "Kutwala nkenda",
    ch: "Kutwala mwenya",
    ng: "Kutwala vihandeka",
    kw: "Okutwala oshilongo",
    nh: "Okutwala omilandu",
    fi: "Twala mutinu"
  },
