            ...
            <div className="border border-slate-200 rounded-xl p-2 bg-white flex flex-wrap items-center justify-between gap-1.5 shadow-xs">
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                <div className="flex items-center gap-0.5">
                  ...
                  <label
                    className="p-1.5 rounded-lg text-slate-600 hover:bg-slate-100 hover:text-blue-600 transition-all cursor-pointer flex items-center justify-center relative"
