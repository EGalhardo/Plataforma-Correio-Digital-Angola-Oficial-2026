...
Ao criar uma plataforma nacional centralizada de correspondência digital, Angola poderá reduzir drasticamente a burocracia, aumento da eficiência das instituições públicas e offercer aos cidadãos uma experiência moderna, rápida e segura no acesso aos serviços governamentais.
...
O histórico digital permitirá organização permanente das cookies oficiais, facilitando consultas futuras e gestão documental pessoal.
